...
![mcp配置](https://19921514.xyz/fb/api/public/dl/3kDTYR8d/roocode_mcp.png?inline=true)
...
![显示求和](https://19921514.xyz/fb/api/public/dl/3kDTYR8d/roocode_mcp_sum.png?inline=true)

### 显示文件列表

使用listdir工具显示 /home/xx/Documents下的文件列表，效果如下

![显示文件列表](https://19921514.xyz/fb/api/public/dl/3kDTYR8d/roocode_mcp_listdir.png?inline=true)
